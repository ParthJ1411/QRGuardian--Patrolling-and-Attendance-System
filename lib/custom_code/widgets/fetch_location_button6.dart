...
class FetchLocationButton6 extends StatefulWidget {
  const FetchLocationButton6({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<FetchLocationButton6> createState() => _FetchLocationButton6State();
}

class _FetchLocationButton6State extends State<FetchLocationButton6> {
  LatLng? _currentLocation;
  String? _errorMessage;
  bool _isWithinRadius = false;

  final LatLng targetLocation6 = LatLng(18.601609242560933, 73.72414807575123);
    ...
    if (_currentLocation != null) {
      ...
      setState(() {
        if (isValid) {
          ...
          FFAppState().PrideState = true;
        } else {
          _isWithinRadius = false;
          _errorMessage =
              'Current location is not within 1000 meters of the target location';
        }
      });
    } else {
      setState(() {
