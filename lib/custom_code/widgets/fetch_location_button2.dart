...
class FetchLocationButton2 extends StatefulWidget {
  const FetchLocationButton2({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<FetchLocationButton2> createState() => _FetchLocationButton2State();
}

class _FetchLocationButton2State extends State<FetchLocationButton2> {
  LatLng? _currentLocation;
  String? _errorMessage;
  bool _isWithinRadius = false;

  final LatLng targetLocation2 = LatLng(18.584662533668848, 73.73616115749329);
    ...
    if (_currentLocation != null) {
      ...
      setState(() {
        if (isValid) {
          ...
          FFAppState().BoysHostelState = true;
        } else {
          _isWithinRadius = false;
          _errorMessage =
