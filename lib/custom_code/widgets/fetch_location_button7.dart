...
class FetchLocationButton7 extends StatefulWidget {
  const FetchLocationButton7({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<FetchLocationButton7> createState() => _FetchLocationButton7State();
}

class _FetchLocationButton7State extends State<FetchLocationButton7> {
  LatLng? _currentLocation;
  String? _errorMessage;
  bool _isWithinRadius = false;

  final LatLng targetLocation7 = LatLng(18.593365129243796, 73.793529271065);
