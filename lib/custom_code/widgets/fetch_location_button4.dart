...
class FetchLocationButton4 extends StatefulWidget {
  const FetchLocationButton4({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<FetchLocationButton4> createState() => _FetchLocationButton4State();
}

class _FetchLocationButton4State extends State<FetchLocationButton4> {
  LatLng? _currentLocation;
  String? _errorMessage;
  bool _isWithinRadius = false;

  final LatLng targetLocation4 = LatLng(18.58481756154072, 73.73775928681172);
